(function ($, App, window) {
	...
	initWidgets = function () {
		...
		dd[0] = window.DropDown({ target: 'dropdown0', defaultText: 'Not selected', action: ddAction });

		dd[1] = window.DropDown({ target: 'dropdown1', defaultValue: 1, action: ddAction,
			items: [{ id: 0, name: 'All items' }, { id: 1, name: 'Item 1' }, { id: 2, name: 'Item 2' }]
		});

		dd[2] = window.DropDown({ target: 'dropdown2', defaultText: 'Items', multiselect: true, action: ddAction,
			showSidebar: true, menuAlign: 'right', emptyText: 'All Items' });

		dd[3] = window.DropDown({ target: 'dropdown3', defaultText: 'Items', multiselect: true });
		replaceList(dd[3]);

		dd[4] = window.DropDown({ target: 'dropdown4', isStatic: true, emptyText: 'User Menu', action: ddAction,
			items: [ { id: 1, name: 'Option 1' }, { id: 2, name: 'Option 2' } ]
		});

		dd[5] = window.DropDown({ target: 'dropdown5', isStatic: true, emptyText: 'Custom Menu',
		...
		dd[6] = window.DropDown({ target: 'dropdown6', emptyText: 'Please select' });

		dd[7] = window.DropDown({ target: 'dropdown7', defaultText: 'Items', multiselect: true,
			additionalOptions: [
